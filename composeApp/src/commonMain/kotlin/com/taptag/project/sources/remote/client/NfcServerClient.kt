...
interface NfcServerClient {
    ...
    suspend fun updateContact(data: ContactsRequestData, id: String): NetworkResult<ContactData>
    suspend fun deleteContact(id: String): NetworkResult<Boolean>
    suspend fun refreshToken(data: RefreshTokenRequestData): NetworkResult<RefreshTokenResponseData>
